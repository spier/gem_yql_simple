...
This is currently more an experiment of ruby gem building than a real ruby gem!!! The gem is usable but still may not be useful for anybody other than myself! You have been warned :)
...
Example of doing a twitter search, using the yql_simple gem.
